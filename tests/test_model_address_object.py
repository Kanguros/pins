...
class TestValidCreation:
    ...
    def test_ip_network_creation(self, input_value):
    ...
    def test_ip_range_creation(self, input_value):
...
class TestEdgeCases:
    ...
    def test_missing_address_in_csv(self):
